            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        ...
                        <a href="/private_pages/add_food" class="template-btn mt-3">book a table</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="private_pages/add_food" class="template-btn template-btn2 mt-4">reservation</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 align-self-center">
                    ...
                    <div class="deshes-text">
                        ...
                        <a href="private_pages/add_food" class="template-btn3 mt-3">book a table <span><i class="fa fa-long-arrow-right"></i></span></a>
                    </div>
                </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <form action="#">
                        ...
                        <div class="table-btn text-center">
                            <a href="private_pages/add_food" class="template-btn template-btn2 mt-4">book a table</a>
                        </div>
                    </form>
                </div>
            </div>
