...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
    ...
    <script src="<?php echo e(asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyDpfS1oRGreGSBU5HHjMmQ3o5NLw7VdJ6I')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendor/gmaps.min.js')); ?>"></script>
