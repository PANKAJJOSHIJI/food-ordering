        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Pankaj Joshi</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/admin_pages/data_table"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>
        <li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo e(asset('dist/img/user4-128x128.jpg')); ?>" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo e(asset('dist/img/user3-128x128.jpg')); ?>" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo e(asset('dist/img/user2-160x160.jpg')); ?>" alt="user image" class="offline">
