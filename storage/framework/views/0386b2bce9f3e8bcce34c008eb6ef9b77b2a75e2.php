    ...
    <header class="header-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="/public_pages/home_page"><img src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="logo"></a>
                    </div>
                </div>
                <div class="col-lg-10">
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="welcome-img">
                        <img src="<?php echo e(asset('assets/images/welcome-bg.png')); ?>" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        ...
                        <a href="/login" class="template-btn mt-3">book a table</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food1.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-sm-0">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food2.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-md-0">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food3.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>topu lasange</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food4.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food5.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>bean salad</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/food6.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="/login" class="template-btn template-btn2 mt-4">reservation</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 align-self-center">
                    ...
                    <div class="deshes-text">
                        ...
                        <a href="/login" class="template-btn3 mt-3">book a table <span><i class="fa fa-long-arrow-right"></i></span></a>
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="<?php echo e(asset('assets/images/deshes1.png')); ?>" alt="" class="img-fluid">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="<?php echo e(asset('assets/images/deshes2.png')); ?>" alt="" class="img-fluid">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="testimonial-slider owl-carousel">
                        ...
                        <div class="single-slide d-sm-flex">
                            <div class="customer-img mr-4 mb-4 mb-sm-0">
                                <img src="<?php echo e(asset('assets/images/customer2.png')); ?>" alt="">
                            </div>
                            <div class="customer-text">
                                <h5>adam nahan</h5>
                                <span><i>Chief Customer</i></span>
                        ...
                        <div class="single-slide d-sm-flex">
                            <div class="customer-img mr-4 mb-4 mb-sm-0">
                                <img src="<?php echo e(asset('assets/images/customer1.png')); ?>" alt="">
                            </div>
                            <div class="customer-text">
                                <h5>adame nesane</h5>
                                <span><i>Chief Customer</i></span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/update1.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                ...
                <div class="col-md-4">
                    <div class="single-food my-5 my-md-0">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/update2.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="post-admin d-lg-flex mb-3">
                                <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                ...
                <div class="col-md-4">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="<?php echo e(asset('assets/images/update3.jpg')); ?>" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="post-admin d-lg-flex mb-3">
                                <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <form action="#">
                        ...
                        <div class="table-btn text-center">
                            <a href="/login" class="template-btn template-btn2 mt-4">book a table</a>
                        </div>
                    </form>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made By <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Pankaj Joshi</a>
